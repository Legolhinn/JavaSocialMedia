...
<%
    ...
    user.showFriends(request, user.getUserID());
    user.showPosts(request);
    ...
    <div class="col-md-3">
      ...
      <div class="panel panel-default">
        <div class="media-left">
          <img src="<%=user.getImgPath(user.getUserID())%>" class="media-object" style="width: 128px; height: 128px;">
        </div>
        <div class="panel-body">
          <h2><%=user.getUserName()%></h2>
          <p><%=user.updateUser(user.getUserID())%></p>
        </div>
      </div>
      <!-- ./profile brief -->
      ...
      <div class="panel panel-default">
        <div class="panel-body">
          ...
          <ul>
            <li>
              <a href="Profile?userID=<%=_request%>"><%= user.getUserByID(_request)%></a>
    ...
    <div class="col-md-3">
      ...
      <div class="panel panel-default">
        <div class="panel-body">
          ...
          <ul>
            <li>
              <a href="Profile?userID=<%=users%>"><%=user.getUserByID(users)%></a>
      ...
      <div class="panel panel-default">
        <div class="panel-body">
          ...
          <ul>
            <li>
              <a href="Profile?userID=<%=friend%>"><%=user.getUserByID(friend)%></a>
