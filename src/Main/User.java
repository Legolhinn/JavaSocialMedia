...
public class User
{
    ...
    public String getImgPath(int _userID) throws  Exception
    {
        Class.forName("com.mysql.cj.jdbc.Driver");
        try
        {
    ...
    public String updateUser(int _userID) throws Exception, SQLException
    {
        Class.forName("com.mysql.cj.jdbc.Driver");
        Connection connection = DriverManager.getConnection(url, dbUser, dbPassword);
        String query = "SELECT * FROM users";
    ...
    public void showFriends(HttpServletRequest req, int _userID) throws Exception
    {
        friendList.clear();
        requestList.clear();
        Class.forName("com.mysql.cj.jdbc.Driver");
        ...
        try {
            ...
            while (result.next())
            {
                ...
                else if (result.getInt(2) == _userID)
                {
                    if (result.getString(3).equals("Y"))
    ...
    public void UpdateStatus(HttpServletRequest req, HttpServletResponse res, String _status,int _userID)throws Exception
    {
        Class.forName("com.mysql.cj.jdbc.Driver");
        try {
            Connection connection = DriverManager.getConnection(url, dbUser, dbPassword);
    ...
    public void showPosts(HttpServletRequest req) throws  Exception
    {
    ...
    public void showPosts(HttpServletRequest req, int userID) throws  Exception
    {
        ArrayList<Node> postList = new ArrayList<Node>();
        Class.forName("com.mysql.cj.jdbc.Driver");
        HttpSession session = req.getSession();
    ...
    public void AddFriendList(HttpServletRequest req) throws Exception
    {
